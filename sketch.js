...
function setup() {
 ...
 block17 = new Block(660,205,30,40);
 block18 = new Block(690,205,30,40);
 block19 = new Block(720,205,30,40);
 block20 = new Block(750,205,30,40);

 block21 = new Block(780,205,30,40);
 block22 = new Block(690,165,30,40);
 block23 = new Block(720,165,30,40);
 block24 = new Block(750,165,30,40);
 block25 = new Block(720,125,30,40);
